CREATE TABLE `ps_map_data_source_gungames` (
  ...
  `knifelvlsgained` smallint unsigned NOT NULL default '0',
  `knifelvlsgiven` smallint unsigned NOT NULL default '0',
  `knifesteal` smallint unsigned NOT NULL default '0',
  `leader` smallint unsigned NOT NULL default '0',
  `triplelevel` smallint unsigned NOT NULL default '0',
  `lastlevel` smallint unsigned NOT NULL default '0',
...
INSERT INTO `ps_config_plrbonuses` (`id`, `eventname`, `enactor`, `enactor_team`, `victim`, `victim_team`, `description`, `gametype`, `modtype`) 
    VALUES 
        ...
        (80,'gg_leader',1,0,0,0,'player was appointed as leader','source','gungames'),
        (81,'gg_levelup',1,0,0,0,'player gained a level','source','gungames'),
        (82,'gg_leveldown',-1,0,0,0,'player lost a level','source','gungames'),
        (83,'gg_knife_level',1,0,0,0,'player gained a knife level','source','gungames'),
        (84,'gg_knife_steal',2,0,0,0,'player stole a level with a knife','source','gungames'),
        (85,'gg_triple_level',3,0,0,0,'player gained 3 levels in a triple level event','source','gungames'),
        (86,'gg_last_level',1,0,0,0,'player reached the maximum level','source','gungames'),
        (87,'gg_win',0,5,0,-5,'TEAM event that fires when a round ends and a team won','source','gungames');
...
INSERT INTO `ps_config_awards` (`id`, `enabled`, `idx`, `type`, `negative`, `class`, `name`, `groupname`, `phrase`, `expr`, `order`, `where`, `limit`, `format`, `gametype`, `modtype`, `rankedonly`, `description`) 
    VALUES 
        ...
        (80,1,800,'player',0,'','Most Levels Gained','','{$player.link} has gained a total of {$award.value} levels','{$lvlsgained} * 100','desc','{$lvlsgained} >= 5',25,'commify','source','gungames',1,'Player with the most levels gained (must have gained at least 5 levels to count)'),
        (81,1,810,'player',0,'','Most Knife Levels Gained','','{$player.link} has gained a total of {$award.value} knife levels','{$knifelvlsgained} * 100','desc','{$lvlsgained} >= 5',25,'commify','source','gungames',1,'Player with the most knife levels gained (must have gained at least 5 levels to count)'),
        (82,1,820,'player',1,'','The Eternal Victim','','{$player.link} has lost the most levels ({$award.value})','{$lvlslost}','desc','',0,'commify',NULL,NULL,1,'Player who has lost the most levels'),
        (83,1,830,'player',0,'','Blood Sucking Vampire','','{$player.link} has stolen the most levels with a knife ({$award.value})','{$knifesteal}','desc','',25,'commify','source','gungames',1,'Player with the most levels stolen with a knife'),
        (84,1,840,'player',0,'','Take Me to Your Leader','','{$player.link} has been appointed leader the most times ({$award.value})','{$leader}','desc','{$leader} >= 5',25,'commify','source','gungames',1,'Player appointed leader the most times (must have been appointed at least 5 times to count)');
