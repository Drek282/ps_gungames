...
#
#	$Id: source.pm 540 2008-08-18 10:54:48Z lifo $
#
package PS::Game::source;
...
sub event_round {
	...
	$trigger = lc $trigger;
	# mini_round_start is a TF2 trigger, but its more efficient to put it here instead of source/tf2.pm
